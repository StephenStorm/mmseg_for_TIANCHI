_base_ = [
    ...
    '../_base_/datasets/tianchi.py', '../_base_/default_runtime.py',
...
# checkpoint_file = '/opt/tiger/workspace/mmsegmentation/work_dirs/upernet_convnext_xlarge_fp16_640x640_160k_ade20k/iter_4000.pth'
model = dict(
    backbone=dict(
        type='mmcls.ConvNeXt',
        arch='xlarge',
